        ...
        >
          ...
          <div className="space-y-8">
             <motion.h2
               ...
               className="font-bold text-4xl sm:text-5xl md:text-6xl lg:text-8xl text-white"
             >
             ...
             <motion.div
               ...
               className="glass p-6 sm:p-8 rounded-2xl space-y-6 sm:space-y-8 h-auto backdrop-blur-lg bg-white/10 border border-white/10 shadow-lg flex flex-col gap-6 sm:gap-8"
             >
               {/* Phone */}
               <div className="space-y-2">
                 ...
                 <a
                   href="tel:+9999999999"
                   className="text-lg sm:text-2xl font-bold hover:text-gray-400 transition duration-300 flex items-center gap-2 text-gray-400"
                 >
               +91 7773091428
                 </a>
               </div>
               ...
               <div className="space-y-2">
                 ...
                 <a
                   ...
                   className="text-lg sm:text-xl md:text-2xl font-bold hover:text-gray-400 transition duration-300 flex items-center gap-2 text-gray-400"
                 >
